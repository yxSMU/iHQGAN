...
def train(dataset_str, patches, layers, n_data_qubits, batch_size, checkpoint,
    ...
    out_dir = "TraninResult\canny_archi_normal\\result_A2B"
    out_dir_2 = "TraninResult\canny_archi_normal\\result_B2A"
    out_dir_3 = "TraninResult\canny_archi_normal\\result_A_real"
    out_dir_4 = "TraninResult\canny_archi_normal\\result_B_real"
    out_dir_5 = "TraninResult\canny_archi_normal\\a2a"
    out_dir_6 = "TraninResult\canny_archi_normal\\b2b"
    ...
    gan_2 = PQWGAN_CC(image_size=image_size, image_size_2=image_size_2, channels=1, n_generators=patches,
                       n_qubits=qubits,
                       n_ancillas=ancillas, n_layers=layers, patch_shape=patch_shape)
    ...
    for epoch in trange(n_epochs):
        for i, batch in tqdm(enumerate(dataloader)):
            ...
            if i % n_critic == 0:
                ...
                image_bab = generator(pred_images_A)
