...
|                                                              |
| :----------------------------------------------------------: |
| <img src="Fig/iHQGAN_framework.png" alt="iHQGAN_framework" width="300"/> |

Please refer to our [paper](https://arxiv.org/pdf/2411.13920) for more details.

## Experiment Results 

|       *Edge  Detection*        |        *Font  Style  Transfer*        |         *Image Denosing*          |
| :----------------------------: | :-----------------------------------: | :-------------------------------: |
| ![Table](Fig/Edge_Dection.png) | ![Table](Fig/Font_Style_Transfer.png) | ![Table](Fig/Image_Denoising.png) |
